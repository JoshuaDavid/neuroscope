...
if args.model:
    ...
    make_page_file(os.path.join(WEBSITE_DIR, "index.html"), model_html)
    make_page_file(os.path.join(WEBSITE_DIR, "model.html"), REDIRECT_TO_INDEX)
    make_page_file(os.path.join(WEBSITE_DIR, "random.html"), make_random_redirect_2d(cfg.n_layers, cfg.d_mlp))
